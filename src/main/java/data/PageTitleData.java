...
public class PageTitleData {
	public final static String CART_PAGE_TITLE = "Amazon.com Shopping Cart";
	public final static String LANDING_PAGE_TITLE = "Amazon.com. Spend less. Smile more.";
	public final static String LOGGED_IN_LANDING_PAGE_TITLE = "Your Account";
	public final static String LOGIN_FAILURE_PAGE_TITLE = "Authentication required";
