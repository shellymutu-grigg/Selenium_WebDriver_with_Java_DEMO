...
public class SearchOrdersTest extends TestSetup{
	...
	public void searchOrdersTest(Method method) {
		...
		TestAssert.elementNotNull(Element.getElement(By.xpath("//*[contains(text(), '"+ TextData.ACCOUNT_MENU_LINK_TEXT +"')]"), webDriver), "pauseForOrdersPage()");
		...
		TestAssert.elementNotNull(Element.getElement(By.xpath("//h1[normalize-space()='"+ TextData.YOUR_ORDERS_TEXT +"']") , webDriver), "openOrderPage()");
		...
		TestAssert.elementNotNull(Element.getElement(By.xpath("//*[contains(text(), '"+ TextData.SEARCH_RESULTS_TEXT +"')]"), webDriver), "searchForOrders()");
